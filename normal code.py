...
הוראות וחוקי המשחק
return """לנחש תצטרכו זה במשחק המפורסם! המילים משחק של והחכמה הדיגיטלית לגרסה הבאים ברוכים
אמת. בזמן המסך על שיופיעו רמזים בעזרת סודיות מילים

הראשי בתפריט המשחק הגדרת :1 שלב
  הבית: במסך הנתונים את מגדירים לדרך, שיוצאים לפני
• .שלכם השם את הקלידו שחקן: שם
• .ועוד חיות חפצים, אוכל, שתרצו המילים נושא את בחרו קטגוריה: בחירת
• .לכם המתאימה הקושי רמת את בחרו קושי: רמת
• .ניקוד חישוב ללא בכיף לשחק כדי אימון מצב לסמן ניתן אימון: מצב
• .השמש או ירח כפתור באמצעות שחור כהה למצב לבן בהיר תצוגה מצב בין להחליף באפשרותכם :מסך צבע בחירת
• חזרה לדף הבית: בכל שלב במשחק ניתן ללחוץ על כפתור חזור לדף הבית כדי לשנות שם, קטגוריה או קושי
  שימו לב: חזרה לדף הבית מוחקת את היסטוריית המשחק והניקוד יתאפס ויתחיל מהתחלה

והרמזים המשחק מהלך :2 שלב
  לרוץ, מתחיל המילה של הטיימר נבחרת, הסודית המילה - משחק התחל על לוחצים
• מופיע. הראשון והרמז אם רק ייחשף הבא הרמז כך. סתם רמז לבקש אי אפשר רמזים? עוד מקבלים איך
• .רמזים 5 מקסימום יש מילה לכל .נכון לא ניחשתם המשחק: במהלך עזרה כפתורי
  תשובה: גלה
  הבאה. למילה על ללחוץ לכם ותאפשר הסודית, המילה את מיד תחשוף זה כפתור על לחיצה נתקעתם, אם
  דלג:
  .הלאה אתכם ותעביר הנוכחית המילה את תחשוף זה כפתור על לחיצה

והזמן הניקוד שיטת :3 שלב
  המילה: את לנחש כדי לראות שנאלצתם הרמזים כמות לפי נקבע שלכם הניקוד
• .נקודות 10 ב- מזכה בלבד 1 רמז לפי נכון ניחוש
• .נקודות 7 ב- מזכה רמזים 2 לפי נכון ניחוש
• .נקודות 4 ב- מזכה רמזים 3 לפי נכון ניחוש
• .נקודות 2 ב- מזכה רמזים 4 לפי נכון ניחוש
• .נק0 בנקודות מזכה לא רמזים 5 לפי נכון ניחוש

נגמר הנוכחית המילה של הזמן אם בנפרד. מילה לכל מוגדר הטיימר עבר! הזמן
  להמשיך. כדי הבאה כפתור על ללחוץ ותצטרכו אוטומטית, תתגלה הסודית המילה - לנחש שהספקתם לפני"""
