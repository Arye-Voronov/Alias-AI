...
5) רמזים: בחרו רמזים מוכנים מראש או AI שמשפר את הרמזים.
6) אורך משחק: בחרו אם לשחק את כל הקטגוריה או מספר מילים מוגבל.
...
1) ניחוש נכון לפי רמז 1: 10 נקודות.
2) ניחוש נכון לפי רמז 2: 7 נקודות.
3) ניחוש נכון לפי רמז 3: 4 נקודות.
4) ניחוש נכון לפי רמז 4: 2 נקודות.
5) ניחוש נכון לפי רמז 5: 0 נקודות.
