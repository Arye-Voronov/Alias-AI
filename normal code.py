...
הוראות וחוקי המשחק
"ברוכים הבאים לגרסה הדיגיטלית והחכמה של משחק המילים המפורסם! זה משחק שבו תצטרכו לנחש מילים סודיות בעזרת רמזים שיופיעו על המסך בזמן אמת\n\n"
"שלב 1: הגדרת המשחק (בתפריט הראשי)\n"
"• לפני שיוצאים לדרך, מגדירים את הנתונים במסך הבית: השם את הקלידו :שם שחקן\n"
"• בחירת קטגוריה: בחרו את נושא המילים שתרצו (אוכל, חפצים, חיות ועוד 1)\n"
"• רמת קושי: בחרו את רמת הקושי המתאימה לכם\n"
"• מצב אימון: ניתן לסמן \"מצב אימון\" כדי לשחק בכיף ללא חישוב ניקוד\n"
"• בחירת צבע מסך: באפשרותכם להחליף בין מצב תצוגה בהיר (לבן) למצב כהה (שחור) באמצעות כפתור השמש/ירח\n"
"• חזרה לדף הבית: בכל שלב במשחק ניתן ללחוץ על כפתור \"חזור לדף הבית\" כדי לשנות שם, קטגוריה או קושי. שימו לב: חזרה לדף הבית מוחקת את היסטוריית המשחק והניקוד יתאפס ויתחיל מהתחלה\n\n"
"שלב 2: מהלך המשחק והרמזים\n"
"• לוחצים על \"התחל משחק\" – המילה הסודית נבחרת, והטיימר של המילה מתחיל לרוץ\n"
"• איך מקבלים עוד רמזים? אי אפשר לבקש רמז סתם כך. הרמז הבא ייחשף רק אם ניחשתם לא נכון והרמז הראשון מופיע. לכל מילה יש מקסימום 5 רמזים\n"
...
"  🟢 ניחוש נכון לפי רמז 1 בלבד: מזכה ב-10 נקודות\n"
"  🟡 ניחוש נכון לפי 2 רמזים: מזכה ב-7 נקודות\n"
"  💡 ניחוש נכון לפי 3 רמזים: מזכה ב-4 נקודות\n"
"  🧡 ניחוש נכון לפי 4 רמזים: מזכה ב-2 נקודות\n"
"  🔴 ניחוש נכון לפי 5 רמזים: לא מזכה בנקודות (0 נק')\n\n"
"⏱ הזמן עבר! הטיימר מוגדר בנפרד לכל מילה. אם הזמן של המילה הנוכחית נגמר לפני שהספקתם לנחש – המילה הסודית תתגלה אוטומטית, ותצטרכו ללחוץ על כפתור \"הבאה\" כדי להמשיך"
